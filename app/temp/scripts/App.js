...
var revealFeaturesOnScroll = new _RevealOnScroll2.default((0, _jquery2.default)(".feature-item"), "85%");
var revealTestimonialsOnScroll = new _RevealOnScroll2.default((0, _jquery2.default)(".testimonial"), "60%");
...
var MobileMenu = function () {
  function MobileMenu() {
    ...
    this.events(); //javascripts needs this to supervise the events method.
  }
...
var RevealOnScroll = function () {
  function RevealOnScroll(DOMelements, fadeInOffset) {
    _classCallCheck(this, RevealOnScroll);

    this.itemsToReveal = DOMelements;
    this.offsetPercentage = fadeInOffset;
